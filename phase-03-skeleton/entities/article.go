...
// articlePriceChangedEvent is a private aggregate-recorded event used in Phase 03
// to demonstrate "record, don't publish" without introducing the later event
// publishing layer.
