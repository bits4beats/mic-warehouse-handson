...
// MySQLArticleRepository implements interfaces.ArticleRepository against the
// Warehouse BC MySQL schema (warehouse-init.sql). It is not a legacy-schema
// adapter; a real legacy side would need a dedicated LegacyMySQLArticleRepository
// that translates price DECIMAL and other legacy fields at the boundary.
